  ...
  return (
    <div className="font-roboto">
      ...
      <div className="max-w-6xl mx-auto mb-6 px-4 lg:mt-[50px]">
        <img
          src="/assets/products/IMMUNO SUPPRESSANT.png" // Change if needed
          alt="ImmunoSuppressant Visual"
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300 text-xs sm:text-sm md:text-base">
            <tbody>
              <tr>
                <td className="border border-gray-300 px-2 py-2 align-top">Tacrolimus IR pellets</td>
                <td className="border border-gray-300 px-2 py-2 align-top">1%</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default ImmunoSuppressant;
