  ...
  return (
    <div className="font-roboto">
      ...
      <div className="max-w-6xl mx-auto mb-6 px-4 lg:mt-[50px]">
        <img
          src="/assets/products/antihiv.png"
          alt="Anti-HIV Drugs"
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300 text-xs sm:text-sm md:text-base">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 px-2 py-2">Didanosine Pellets</td>
                <td className="border border-gray-300 px-2 py-2">60% w/w</td>
              </tr>
            </tbody>
          </table>
        </div>
