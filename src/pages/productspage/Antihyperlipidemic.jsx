  ...
  return (
    <div className="font-roboto">
      ...
      <div className="max-w-6xl mx-auto mb-6 px-4 lg:mt-[50px]">
        <img
          src="/assets/products/ANTI-HYPERLIPIDEMIC.png" // Your middle image
          alt="Antihyperlipidemic Visual"
...
export default Antihyperlipidemic;
