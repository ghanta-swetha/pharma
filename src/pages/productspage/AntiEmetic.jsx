     ...
     <div className="relative w-full h-[220px] sm:h-[280px] md:h-[320px] lg:h-[400px] mb-6">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          ...
          <p className="font-[Roboto] text-white mt-[30px] md:mt-[30px] lg:mt-[40px] text-sm sm:text-base md:text-xl lg:text-[24px] font-bold mt-2">
            Effective pellets to prevent nausea and vomiting.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto mb-6 px-4 lg:mt-[50px]">
        <img
          src="/assets/products/ANTI-EMETIC.png" // Replace with your actual middle image path
          alt="Anti-Emetic Middle Visual"
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300 text-xs sm:text-sm md:text-base">
            <tbody>
              <tr>
                <td className="border border-gray-300 px-2 py-2">Aprepitant IR pellets</td>
                <td className="border border-gray-300 px-2 py-2">40%</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 py-2">Domperidone SR pellets</td>
                <td className="border border-gray-300 px-2 py-2">17%, 20%, 30%, 40%</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 py-2">Domperidone IR pellets</td>
                <td className="border border-gray-300 px-2 py-2">10%, 11%</td>
              </tr>
            </tbody>
          </table>
        </div>
